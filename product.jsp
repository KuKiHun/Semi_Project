			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					...
					<div class="right-top-bar flex-w h-full">
						...
						<a href="#" class="flex-c-m trans-04 p-lr-25"> 로그인 </a> <a
							href="#" class="flex-c-m trans-04 p-lr-25"> 마이페이지 </a> <a
							href="customerService.jsp" class="flex-c-m trans-04 p-lr-25">
							고객센터 </a>
					</div>
				</div>
			</div>
				...
				<nav class="limiter-menu-desktop container">
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li class="active-menu"><a href="product.jsp">구매</a></li>
							...
							<li><a href="contact.jsp">커뮤니티</a>
								<ul class="sub-menu">
									<li><a href="index.html">전체 글 보기</a></li>
									<li><a href="home-02.html">내가 작성한 글 보기</a></li>
								</ul></li>
						</ul>
					</div>
